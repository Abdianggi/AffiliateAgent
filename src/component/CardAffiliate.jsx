        ...
        <div className="bg-transparent py-3 px-5 shadow-[0_-9px_9px_rgba(0,0,0,0.1)] rounded-md mt-6">
            ...
            <div className="flex justify-between mt-2">
                <div>
                    ...
                    <p className="text-lg text-[#004174] font-semibold">{companyName}</p>
                    <p className="text-[#00000080] text-xs">Reseller ID : {resellerId}</p>
                </div>
                <div
                    className={`border-[${qrColor}] text-sm font-light border-[1px] rounded-sm p-1 inline-flex items-center self-center`}
                >
